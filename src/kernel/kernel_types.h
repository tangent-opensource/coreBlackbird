...
typedef enum PrimitiveType {
  ...
  PRIMITIVE_POINT_DISC = (1 << 7),
  PRIMITIVE_POINT_DISC_ORIENTED = (1 << 8),
  PRIMITIVE_MOTION_POINT = (1 << 9),
  ...
  PRIMITIVE_ALL_POINT = (PRIMITIVE_POINT_SPHERE | PRIMITIVE_POINT_DISC | PRIMITIVE_POINT_DISC_ORIENTED | PRIMITIVE_MOTION_POINT),
