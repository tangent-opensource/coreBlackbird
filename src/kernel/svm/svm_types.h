...
typedef enum NodeSdfModType {
  NODE_SDF_MOD_TYPE_DEFAULT,
  NODE_SDF_MOD_TYPE_ONE,
  NODE_SDF_MOD_TYPE_TWO,
  NODE_SDF_MOD_TYPE_THREE,
  NODE_SDF_MOD_TYPE_FOUR,
  NODE_SDF_MOD_TYPE_FIVE,
  NODE_SDF_MOD_TYPE_SIX,
  NODE_SDF_MOD_TYPE_SEVEN,
} NodeSdfModType;
...
typedef enum NodeSdfMode {
  NODE_SDF_2D_CIRCLE,
  NODE_SDF_2D_BOX,
  NODE_SDF_2D_RHOMBUS,
  NODE_SDF_2D_TRIANGLE,
  NODE_SDF_2D_LINE,
  NODE_SDF_2D_STAR,
  NODE_SDF_2D_HEXAGON,
  NODE_SDF_3D_SPHERE,
  ...
  NODE_SDF_3D_TORUS,
  NODE_SDF_3D_CONE,
  NODE_SDF_3D_CYLINDER,
  NODE_SDF_3D_CAPSULE,
  NODE_SDF_3D_OCTAHEDRON,
  NODE_SDF_3D_HEX_PRISM,
  NODE_SDF_2D_PIE,
  NODE_SDF_2D_ARC,
  NODE_SDF_2D_BEZIER,
  NODE_SDF_2D_UNEVEN_CAPSULE,
  NODE_SDF_2D_POINT_TRIANGLE,
  NODE_SDF_2D_TRAPEZOID,
  NODE_SDF_2D_VESICA,
  NODE_SDF_2D_CROSS,
  NODE_SDF_2D_ROUNDX,
  NODE_SDF_2D_HORSESHOE,
  NODE_SDF_2D_PARABOLA,
  NODE_SDF_2D_ELLIPSE,
  NODE_SDF_2D_ISOSCELES,
  NODE_SDF_2D_ROUND_JOINT,
} NodeSdfMode;

typedef enum NodeSdfOps {
  NODE_SDF_OP_ROUND,
  NODE_SDF_OP_ONION,
  NODE_SDF_OP_BLEND,
  NODE_SDF_OP_UNION,
  NODE_SDF_OP_INTERSECTION,
  NODE_SDF_OP_DIFFERENCE,
  NODE_SDF_OP_UNION_SMOOTH,
  NODE_SDF_OP_INTERSECTION_SMOOTH,
  NODE_SDF_OP_DIFFERENCE_SMOOTH,
} NodeSdfOps;
